...
export default function ResetPasswordClient() {
  ...
  if (!token) {
    return (
      <div className="text-center text-red-500 text-sm bg-red-50 p-3 rounded-lg mb-4">
        ...
        <div className="w-full max-w-4xl h-auto md:h-[600px] bg-white shadow-2xl rounded-3xl overflow-hidden flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/2 p-8 md:p-10 relative bg-gradient-to-br from-white to-sky-50 flex flex-col justify-center">
            ...
            <div className="relative z-10">
              <SlideUp delay={300}>
                <h2 className="text-2xl md:text-3xl font-bold text-center text-gray-800 mb-2">Reset Password</h2>
              </SlideUp>
              <p className="text-center text-gray-600 text-sm mb-6">Masukkan password baru untuk akun Anda.</p>

              {error && (
                <SlideUp delay={400}>
                  <p ref={errorRef} className="text-red-500 text-sm text-center mb-4 bg-red-50 p-3 rounded-lg">
                    {error}
                  </p>
                </SlideUp>
              )}
              ...
              {success && (
                <SlideUp delay={400}>
                  <p ref={successRef} className="text-green-500 text-sm text-center mb-4 bg-green-50 p-3 rounded-lg">
                    {success}
                  </p>
                </SlideUp>
              )}
                ...
                <SlideUp delay={500}>
                  <div>
                    ...
                    <input
                      ...
                      className="w-full p-3 border border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-sky-400 focus:border-sky-500 bg-white text-gray-900 placeholder-gray-500 transition duration-200 ease-in-out"
              ...
              <SlideUp delay={800} className="text-center mt-6">
                <Link href="/login" className="text-sm text-sky-700 hover:text-sky-900 font-medium hover:underline transition-all">
                  Kembali ke Login
                </Link>
              </SlideUp>
            </div>
